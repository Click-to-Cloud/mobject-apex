...
var nJruq = function (_Component) {
  _inherits(nJruq, _Component);

  function nJruq() {
    _classCallCheck(this, nJruq);

    return _possibleConstructorReturn(this, (nJruq.__proto__ || Object.getPrototypeOf(nJruq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(nJruq, _step_6Soy2.default);

exports.default = nJruq;
...
exports.templates = exports.nJruq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace nJruq.
   * @public
   */

  goog.module('nJruq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'nJruq.render';
  }
...
_metalSoy2.default.register(nJruq, templates);
exports.nJruq = nJruq;
