...
var aeThX = function (_Component) {
  _inherits(aeThX, _Component);

  function aeThX() {
    _classCallCheck(this, aeThX);

    return _possibleConstructorReturn(this, (aeThX.__proto__ || Object.getPrototypeOf(aeThX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(aeThX, _indexSoy2.default);

exports.default = aeThX;
...
exports.templates = exports.aeThX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace aeThX.
   * @public
   */

  goog.module('aeThX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'aeThX.render';
  }
...
_metalSoy2.default.register(aeThX, templates);
exports.aeThX = aeThX;
