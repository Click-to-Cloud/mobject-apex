...
goog.loadModule(function (exports) {
  ...
  function $header(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('a', null, null, 'href', '/mobject-apex/tutorials/getting_started/step_1.html', 'class', 'btn btn-accent btn-sm');
    itext('Get Started');
    ie_close('a');
    ie_open('a', null, null, 'href', 'https://github.com/Click-to-Cloud/MObject.apex/', 'class', 'btn btn-success btn-sm');
    itext('GitHub');
    ie_close('a');
  ...
  function $features(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Managed Objects');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('MObject.apex manages your SObjects and carries out DML operations in one call.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Functional Chaining');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('MObject.apex provides easy API so that you can chain your method calls.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Namespace Hassle Free');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('MObject.apex takes care of namespace issue of the SObjects for you.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
  ...
  function $how(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('MObject.apex has only a few APIs, but they are powerful.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $highlights(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Easy Persistence');
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('MObject.apex tracks changes and flushes them in one call.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/mobject-apex/images/highlight_1.png', 'alt', 'Easy Persistence', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_open('h4', null, null, 'class', 'highlight-title');
    itext('Method Chaining');
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('MObject.apex offers chainable methods for you to use.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-2 col-md-pull-6');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/mobject-apex/images/highlight_2.png', 'alt', 'Method Chaining', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ie_open('div', null, null, 'class', 'col-md-6 col-md-offset-2');
    ie_open('h4', null, null, 'class', 'highlight-title');
    itext('Namespace Solved');
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('MObject.apex helps you to solve the namespace issue.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/mobject-apex/images/highlight_3.png', 'alt', 'Namespace Solved', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_close('div');
