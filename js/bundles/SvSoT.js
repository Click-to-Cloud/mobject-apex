...
var SvSoT = function (_Component) {
  _inherits(SvSoT, _Component);

  function SvSoT() {
    _classCallCheck(this, SvSoT);

    return _possibleConstructorReturn(this, (SvSoT.__proto__ || Object.getPrototypeOf(SvSoT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SvSoT, _step_2Soy2.default);

exports.default = SvSoT;
...
exports.templates = exports.SvSoT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SvSoT.
   * @public
   */

  goog.module('SvSoT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SvSoT.render';
  }
...
_metalSoy2.default.register(SvSoT, templates);
exports.SvSoT = SvSoT;
