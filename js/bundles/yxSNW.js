...
var yxSNW = function (_Component) {
  _inherits(yxSNW, _Component);

  function yxSNW() {
    _classCallCheck(this, yxSNW);

    return _possibleConstructorReturn(this, (yxSNW.__proto__ || Object.getPrototypeOf(yxSNW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yxSNW, _methodsSoy2.default);

exports.default = yxSNW;
...
exports.templates = exports.yxSNW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace yxSNW.
   * @public
   */

  goog.module('yxSNW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'yxSNW.render';
  }
...
_metalSoy2.default.register(yxSNW, templates);
exports.yxSNW = yxSNW;
