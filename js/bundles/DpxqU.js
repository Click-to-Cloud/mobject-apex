...
var DpxqU = function (_Component) {
  _inherits(DpxqU, _Component);

  function DpxqU() {
    _classCallCheck(this, DpxqU);

    return _possibleConstructorReturn(this, (DpxqU.__proto__ || Object.getPrototypeOf(DpxqU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DpxqU, _creationSoy2.default);

exports.default = DpxqU;
...
exports.templates = exports.DpxqU = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace DpxqU.
   * @public
   */

  goog.module('DpxqU.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'DpxqU.render';
  }
...
_metalSoy2.default.register(DpxqU, templates);
exports.DpxqU = DpxqU;
