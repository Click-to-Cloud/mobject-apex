...
var WvqMQ = function (_Component) {
  _inherits(WvqMQ, _Component);

  function WvqMQ() {
    _classCallCheck(this, WvqMQ);

    return _possibleConstructorReturn(this, (WvqMQ.__proto__ || Object.getPrototypeOf(WvqMQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WvqMQ, _step_1Soy2.default);

exports.default = WvqMQ;
...
exports.templates = exports.WvqMQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WvqMQ.
   * @public
   */

  goog.module('WvqMQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WvqMQ.render';
  }
...
_metalSoy2.default.register(WvqMQ, templates);
exports.WvqMQ = WvqMQ;
