...
var TLtrS = function (_Component) {
  _inherits(TLtrS, _Component);

  function TLtrS() {
    _classCallCheck(this, TLtrS);

    return _possibleConstructorReturn(this, (TLtrS.__proto__ || Object.getPrototypeOf(TLtrS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TLtrS, _step_3Soy2.default);

exports.default = TLtrS;
...
exports.templates = exports.TLtrS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace TLtrS.
   * @public
   */

  goog.module('TLtrS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'TLtrS.render';
  }
...
_metalSoy2.default.register(TLtrS, templates);
exports.TLtrS = TLtrS;
